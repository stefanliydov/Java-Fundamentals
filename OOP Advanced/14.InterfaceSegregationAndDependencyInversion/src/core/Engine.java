...
public class Engine {
    private core.CommandHandler commandHandler;

    public Engine(core.CommandHandler commandHandler)
    {
    ...
    public Engine()
    {
        this.commandHandler = new core.CommandHandler();
    }
    ...
    public static void main(String[] args) {
        ...
        core.CommandHandler commandHandler = new core.CommandHandler(ctrl);
